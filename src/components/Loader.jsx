function Loader() {
    ...
    <svg className="animate-spin hds-flight-icon--animation-loading sm:mt-8 mt-9 sm:w-[110px] sm:h-[110px] w-[90px]" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg" fill="none" stroke="#000000" strokeWidth="0.00016">
